...
% Branchクラスの定義
    net.add_branch("pi_transformer",[1,4]);
    net.add_branch("pi_transformer",[2,7]);
    net.add_branch("pi_transformer",[3,9]);
...
% Componentクラスの定義
    ...
    net.a_Bus{5}.add_component("load-power"    );
    net.a_Bus{6}.add_component("load-power"    );
    net.a_Bus{8}.add_component("load-power"    );
