classdef map_forAnime2 < tools.for_graph.map
    ...
    methods
        function obj = map_forAnime2(varargin)
            obj@tools.for_graph.map(varargin{:});
            obj.initialize;
        end
        ...
        function initialize(obj)
            ...
            cellfun(@(b) set(b,'marker', 'none' )          , obj.a_bus)
            ...
            func = @(class) tools.for_graph.function.marker.subject2CompType(class);
