    ...
    methods
        ...
        function build_graph(obj)
            ...
            % ノード・エッジpropertiesの管理クラスの生成
                c = obj.net.a_bus;
                obj.a_bus       = tools.arrayfun(@(i) tools.for_graph.elements.graph_node(obj.Graph,i      ,obj,i,c{i})          , (1:n_bus)');
                obj.a_component = tools.arrayfun(@(i) tools.for_graph.elements.graph_node(obj.Graph,i+n_bus,obj,i,c{i}.component), (1:n_bus)');
                obj.a_branch    = tools.arrayfun(@(i) tools.for_graph.elements.graph_edge(obj.Graph,Edge_idx(i)     ,obj,i), (1:n_br )');
                obj.a_busline   = tools.arrayfun(@(i) tools.for_graph.elements.graph_edge(obj.Graph,Edge_idx(i+n_br),obj,i), (1:n_bus)');
        ...
        function initialize(obj)
            ...
            cellfun(@(c) set(c,'marker', tools.for_graph.function.marker.subject2CompType(c.object)), obj.a_component)
            ...
            cellfun(@(c) set(c,'color' , tools.for_graph.function.Color.subject2CompType(c.object)), obj.a_component);
        ...
        function set_Color_subject2BusType(obj)
            for i = 1:numel(obj.net.a_bus)
                c = obj.net.a_bus{i};
                obj.a_bus{i} = tools.for_graph.function.Color.subject2BusType(c);
            end
        end
        ...
        function set_Color_subject2CompType(obj)
            for i = 1:numel(obj.net.a_bus)
                ...
                obj.a_component{i} = tools.for_graph.function.Color.subject2CompType(c);
            end
        end
