...
%
    ...
    if isequal(nargin, 0) && isequal(nargout, 0)
        disp("         TimeSpan: [           positive vector          ] ");
        disp("       OffsetUnit: [       double scalar or vector      ] ");
        disp("      OffsetState: [ string or integer\scalar or vector ] ");
        disp("      OffsetValue: [ string or integer\scalar or vector ] ");
        disp("         FaultBus: [ string or integer\scalar or vector ] ");         
        disp("         TripComp: [ string or integer\scalar or vector ] ");
        disp("       LoadChange: [ string or integer\scalar or vector ] ");
        disp("         LoadRate: [ scalar, vector or function_handle  ] ");      
        disp("        InputUnit: [ string or integer\scalar or vector ] ");
        disp("        InputName: [ string or integer\scalar or vector ] ");
        disp("       InputValue: [ scalar, vector or function_handle  ] ");      
        return
    end           
    
    options = struct(      'TimeSpan', [], ...
                         'OffsetUnit', [], ...                        
                        'OffsetState', [], ...
                        'OffsetValue', [], ...
                           'FaultBus', [], ...                        
