classdef (Sealed = true) Newton_Raphson_Method < handle
...
%
    ...
    methods
        function obj = Newton_Raphson_Method(opt)            
            arguments                
                opt.?Newton_Raphson_Method
            end            
            ...
            if isempty(obj.NRMJac)
                ...
                switch class(func)
                    ...
                    otherwise
                        error(msg('GUILDA:Newton_Raphson_Method:InvalidInput'))
                end                
            end
    ...
    methods (Access=public)        
        ...
        function [xi,iteration] = solve(obj)            
            ...
            if iteration >= MaxIt                
                warning(msg('GUILDA:Newton_Raphson_Method:MaxIteration'))            
            end
        end        
    end
end