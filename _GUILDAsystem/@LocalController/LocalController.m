classdef LocalController < PowerSystemModel
    ...
    methods
        ...
        function set_equilibrium(obj,c_V,u)
            [cv_Xeq, cv_Ueq] = get_equilibrium(obj, c_V, u);
            obj.cv_Xequilibrium = cv_Xeq;
            obj.cv_Uequilibrium = cv_Ueq;

            if ~isempty(obj.a_LocalController)
                obj.a_LocalController.set_equilibrium(obj, c_V, u);
            end
        end
