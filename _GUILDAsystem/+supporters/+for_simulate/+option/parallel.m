classdef parallel < supporters.for_simulate.option.base

    methods
        function obj = parallel(net,t,data)
        ...
        function idx = apply(obj,t)
            [ftime,ftab] = obj.timetable;
            logi = ftab{:,find(ftime<=t,1,'last')};
            idx = false(numel(logi),1);
            for i = 1:numel(logi)
